# /gemini-spec-only - Create specification document only (no implementation)

## Usage
/gemini-spec-only <feature_description>
...
## Example
/gemini-spec-only Add user authentication with OAuth2 support
