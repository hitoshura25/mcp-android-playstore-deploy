...
def main():
    """CLI entry point."""
    parser = argparse.ArgumentParser(description='MCP server that helps developers set up automated Google Play Store deployment for Android apps')
    ...
    generate_keystore_parser.add_argument(
        ...
        type=str,
        required=True,
        help='Key alias for the signing key'
    )
    ...
    generate_keystore_parser.add_argument(
        '--validity_days',
        type=int,
        help='How many days the key should be valid'
    )
    ...
    generate_github_workflow_parser.add_argument(
        '--java_version',
        type=str,
        help='Java/JDK version to use for builds'
    )
    ...
    validate_github_secrets_parser.add_argument(
        '--required_secrets',
        type=str,
        help='List of secret names to check for'
    )
    ...
    test_deployment_workflow_parser.add_argument(
        '--dry_run',
        action='store_true',
        help='If true, skip actual Play Store upload'
    )
    ...
    try:
        ...
        if args.command == 'generate_signing_config':
            ...
            result = generate_signing_config(
                ...
                signing_strategy=args.signing_strategy
